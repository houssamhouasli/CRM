...
class ReturnController extends Controller
{
    ...
    {
        $return->load(['delivery.order.client', 'returnItems.product', 'livreur', 'validator', 'depot']);
    ...
    {
        try {
            $this->validateReturn($return, auth()->id());
    ...
    public function reject(Request $request, ReturnModel $return)
    {
        ...
        try {
            $this->rejectReturn($return, auth()->id(), $validated['reason']);
