...
<div class="row g-3">
    <div class="col-lg-12 mb-2 d-flex justify-content-between align-items-center">
        <a href="{{ route('commercial.orders.show', $delivery->order_id) }}" class="btn btn-outline-custom btn-sm">
        ...
        <div class="data-card animate-in mb-3">
            ...
            <div class="card-body">
                <table class="table table-dark-custom table-borderless mb-0">
                    ...
                    <tr><td class="text-muted">Commande</td><td><a href="{{ route('commercial.orders.show', $delivery->order_id) }}">#{{ $delivery->order_id }}</a></td></tr>
