            ...
            <div class="row g-2 align-items-center">
                <div class="col-md-3">
                    <div class="input-group"> 
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" class="form-control border-start-0 ps-0 form-control-sm" placeholder="Commande (#) ou Client">
                    </div>
                </div>
                <div class="col-md-3">
                    ...
                    <tbody>
                        @forelse($orders as $order)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('commercial.orders.show', $order) }}" class="btn btn-outline-custom btn-sm" title="Détails">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </td>
                            </tr>
