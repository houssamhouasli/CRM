            ...
            <div class="row g-2 align-items-center">
                <div class="col-md-3">
                    <div class="input-group"> 
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" class="form-control border-start-0 ps-0 form-control-sm" placeholder="Livraison (#) ou Client">
                    </div>
                </div>
                <div class="col-md-3">
                ...
                <table class="table table-dark-custom table-hover mb-0">
                    <thead>
                        <tr>
                            ...
                            <th>Commande <button class="btn btn-link p-0 border-0 text-secondary" wire:click="sortBy('order')"><i class="bi bi-arrow-down-up ms-3"></i></button></th>
                            <th>Client <button class="btn btn-link p-0 border-0 text-secondary" wire:click="sortBy('client')"><i class="bi bi-arrow-down-up ms-3"></i></button></th>
                            <th>Date <button class="btn btn-link p-0 border-0 text-secondary" wire:click="sortBy('delivery_date')"><i class="bi bi-arrow-down-up ms-3"></i></button></th>
                            <th>Total TTC <button class="btn btn-link p-0 border-0 text-secondary" wire:click="sortBy('total_ttc')"><i class="bi bi-arrow-down-up ms-3"></i></button></th>
                    ...
                    <tbody>
                        @forelse($deliveries as $delivery)
                            <tr>
                                ...
                                <td><a href="{{ route('commercial.orders.show', $delivery->order_id) }}">#{{ $delivery->order_id }}</a></td>
                                ...
                                <td>{{ number_format($delivery->total_ttc, 2, ',', ' ') }} MAD</td>
                                <td>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('commercial.deliveries.show', $delivery) }}" class="btn btn-outline-custom btn-sm" title="Détails">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </td>
                            </tr>
