...
<div class="row">
                    ...
                    <table class="table table-dark-custom mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $item->condition_type === 'unsold' ? 'info' : ($item->condition_type === 'damaged' ? 'warning' : 'danger') }}">
        ...
        <div class="data-card mt-3">
            ...
            <div class="card-body">
                <div class="d-flex gap-2">
                    <form action="{{ route('depositaire.returns.validate', $return) }}" method="POST" class="d-inline">
                        @csrf
                    ...
                    <form action="{{ route('depositaire.returns.reject', $return) }}" method="POST" class="d-inline">
                        @csrf
    ...
    <div class="col-lg-4">
        ...
        <div class="mt-3">
            <a href="{{ route('depositaire.returns.index') }}" class="btn btn-outline-secondary w-100">
