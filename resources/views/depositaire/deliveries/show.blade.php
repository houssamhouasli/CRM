...
@section('page-title', 'Bons de Livraison #' . $delivery->id)
@section('page-subtitle', 'Détails de l\'expédition')

@section('content')
<div class="row g-3">
    <div class="col-lg-12 mb-2 d-flex justify-content-between align-items-center">
        <a href="{{ route('depositaire.deliveries.index') }}" class="btn btn-outline-custom mt-2 btn-sm mb-2">
    ...
    <div class="col-lg-4">
        <div class="data-card animate-in mb-3">
            <div class="card-header"><h5><i class="bi bi-info-circle me-2"></i>Informations générales</h5></div>
            <div class="card-body">
                <table class="table table-dark-custom table-borderless mb-0">
                    <tr><td class="text-muted">Bon Livraison</td><td><strong>#{{ $delivery->id }}</strong></td></tr>
                    <tr><td class="text-muted">Commande ref</td><td><a href="{{ route('depositaire.orders.show', $delivery->order_id) }}">Order #{{ $delivery->order_id }}</a></td></tr>
                    ...
                    <tr><td class="text-muted">Dépôt d'origine</td><td>{{ $delivery->depot->name ?? '—' }}</td></tr>
    ...
    <div class="col-lg-8">
        <div class="data-card animate-in">
            <div class="card-header"><h5><i class="bi bi-box-seam me-2"></i>Contenu du Bon de Livraison</h5></div>
                ...
                <div class="table-responsive">
                    <table class="table table-dark-custom mb-0">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td colspan="6" class="text-end text-muted small">TVA</td>
                                <td class="text-end">{{ number_format($delivery->total_tva, 2, ',', ' ') }} MAD</td>
                                <td></td>
                            </tr>
                            <tr>
                                <td colspan="6" class="text-end fw-bold" style="color:var(--primary);">TOTAL TTC</td>
